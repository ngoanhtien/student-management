                                    ...
                                    <form action="editHP_SV" method="post">
                                        ...
                                        <div class="modal-body">				
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input value="${hpsv.tx1}" type="text" class="form-control" name="tx1" >
                                            </div>
                                            <div class="form-group">
                                                <label>Thường xuyên 2</label>
                                                <input value="${hpsv.tx2}" type="text" class="form-control" name="tx2" >
                                            </div>
                                            <div class="form-group">
                                                <label>Thường xuyên 3</label>
                                                <input value="${hpsv.tx3}" type="text" class="form-control" name="tx3" >
                                            </div>
                                            <div class="form-group">
