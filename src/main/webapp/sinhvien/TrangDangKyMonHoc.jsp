...
<head>
<meta charset="UTF-8">
<title>Trang khung đăng ký học phần</title>
                        ...
                        <div class="table-responsive">
                            <div class="table-wrapper">
                                ...
                                <table class="table table-striped table-hover">
                                    ...
                                    <tbody>
                                    	<c:forEach var="x" items="${li}">
											<tr>
												<td><c:out value="${x.mahp}" /></td>
												<td><c:out value="${x.tenhp}" /></td>
												<td><c:out value="${x.malop}" /></td>
												<td><c:out value="${x.tenlop}" /></td>
												<td><c:out value="${x.mota}" /></td>
												<td><c:out value="${x.soluongsvtoida}" /></td>
												<td><a href="dangkyhp?malop=<c:out value="${x.malop}"/>">Đăng ký</a></td>
											</tr>
										</c:forEach>
                                    </tbody>    
                                </table>
