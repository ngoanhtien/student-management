                                    ...
                                    <tbody>
                                    	<c:forEach var="x" items="${listS}">
											<tr>
												...
												<td>
		                                        	<a href="editSubject?smaHP=<c:out value="${x.maHP}"/>" class="edit">
		                                        		<i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i>
		                                        	</a>
		                                            <a href="#" onclick="showMess(<c:out value="'${x.maHP}'" />)" class="delete" data-toggle="modal">
...
<script type="text/javascript">
 function showMess(maHP) {
	...
	if(option === true){
		window.location.href = 'DeleteCourse?courseCode=' + maHP;
	}
}
</script>
</html>